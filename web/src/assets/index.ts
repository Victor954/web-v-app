...
export {default as Validate} from './form/validation/Validate.vue';

export {default as HasAuthorized} from './utils/HasAuthorized.vue';

export {default as Table} from './table/Table.vue';
export {default as TBody} from './table/TBody.vue';
export {default as THead} from './table/THead.vue';
